    ...
    def get(self, request, *args, **kwargs):
        ...
        return JsonResponse(
            [{"id": user.id,
              ...
              "role": user.role,
              "age": user.age,
              # "total_ads": user.ad_set.filter(is_published=True).count(), - второй вариант
...
class UserUpdateView(UpdateView):
    ...
    def patch(self, request, *args, **kwargs):
        ...
        if "last_name" in data:
            self.object.first_name = data.get("last_name")
        if "username" in data:
            self.object.first_name = data.get("username")
        if "age" in data:
            self.object.first_name = data.get("age")
